function workAudiPortfolio() {
	function getView() {
		const portName = 'work-portfolio-workAudi';
		...
		return `
			<div class="portfolio-details ${portName}">
				...
				<div class="portfolio-details__hero img-loading">
					<div class="constraint portfolio-details__port-title audi-title">
						<h1>Audi USA</h1>
						<h3>Enterprise CMS website</h3>
					</div>
					<img onload="imageLoaded(event)" src="pages/work/img/audi-hero_${size}.jpg">
				</div>
				...
				<div class="constraint portfolio-details__page-content">
						...
						<div class="summary-content">
							...
							<div class="portfolio-details__tech">
								...
								<div class="tech-list">
									...
									<div class="aem">
										<div class="icon aem-icon"></div> Adobe AEM
									</div>
									<div class="jquery">
										<div class="icon jquery-icon"></div> Jquery
									</div>
								</div>
							</div>
						</div>
					...
					<div class="portfolio-details__fold-content">
						...
						<p>
              Google Audi is a globally used event hosting platform for Google products and services
              including Google Cloud, Chrome, Devfest and GML to name a few. My responsibilities as the
              ...
              architecture planning, and component development.
						...
						<div class="portfolio-details__images-container">
							<div class="portfolio-details__content-image port-content-img-left img-loading">
								...
								<img onload="imageLoaded(event)" src="pages/work/img/AUDI_Color_${size}.gif">
							</div>
							<div class="portfolio-details__content-image img-loading">
								<div class="portfolio-details__content-image-header">Audi Gallery</div>
								<img onload="imageLoaded(event)" src="pages/work/img/AUDI_Gallery_${size}.gif">
							</div>
						</div>
					</div>
